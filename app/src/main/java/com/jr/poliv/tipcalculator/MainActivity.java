package com.jr.poliv.tipcalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bundleCheck(savedInstanceState);
    ...
    private void calculateFinalBill() {
        ...
        if(!etBillAmount.getText().toString().equals("") && !etBillAmount.getText().toString().equals(".") && !etBillAmount.getText().toString().equals(null))
    ...
    private void bundleCheck(Bundle savedInstanceState){
